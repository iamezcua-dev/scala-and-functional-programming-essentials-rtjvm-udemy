  ...
  "MyList" should {
    "map integers" when {
      "providing a valid MyTransformer as transformer" in {
        ...
        val myTransformer: Function1[Int, Int] = (element: Int) => pow(element, 2).toInt
    ...
    "flatMap integers" when {
      "providing [n, n*2, n*3] as transformer" in {
        ...
        val myTransformer: Function1[Int, MyList[Int]] = (element: Int) => new Cons(element, new Cons(pow(element, 2).toInt, new Cons(pow(element, 3).toInt, Empty)))
    ...
    "filter integers" when {
      "providing a valid MyPredicate as filter" in {
        ...
        val evenNumbersFilter: Function1[Int, Boolean] = (element: Int) => element % 2 == 0
